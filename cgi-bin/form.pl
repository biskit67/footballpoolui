...
@referers = ('biskit.myzenhost.com','biskitpoolnet.ipage.com','www.yahoo.com','aol.com');

$xtra = 'gridrats84@mymetronet.net';
...
sub send_mail {
    ...
    $email = $Config{'email'};
    ($junk, $domain) = split(/@/, $email);

    # Open The Mail Program
    open(MAIL,"|$mailprog -t");

    print MAIL "To: $Config{'recipient'}\n";
    if ($domain eq 'aol.com' or $domain eq 'yahoo.com') {
      print MAIL "From: $Config{'recipient'} ($Config{'realname'})\n";
    }
    else {

...
echo "         var num = document.fbpool.elements.length - 12\n";
...
print <<<HERE
         ...
         for (var i=2; i<num; i+=3) 
          ...
          entryString2 = document.fbpool.realname.value + "*" + entryString + "*" +  document.fbpool["tiebreaker"].value + "*" + fbWeek + "*" + document.fbpool["sheet type"].value;
...
function printEnd($bye, $tieb, $FbWeek, $pEmail, $pName){
   ...
   echo "<TR>\n";
   echo "<TD width=100></TD>\n";
   echo "<TD>Sheet Type <SELECT maxLength=2 name='sheet type' size=1><option value = ''><option value = 'W'>Weekly</option><option value = 'S'>Season</option><option selected value = 'B'>Both</option> </SELECT>\n"; 
...
function dispGame ($v, $h, $num, $game, $pts, $color) {
        ...
        echo " <TD bgcolor=$color width=15><SELECT name='$pts' ><option value = '0' selected>0<option value = '1'>1<option value = '2'>2<option value = '3'>3<option value = '4'>4<option value = '5'>5<option value = '6'>6<option value = '7'>7<option value = '8'>8<option value = '9'>9<option value = '10'>10<option value = '11'>11<option value = '12'>12<option value = '13'>13<option value = '14'>14<option value = '15'>15<option value = '16'>16 </SELECT></TD>\n";
        echo "</TR>\n";}
?>
</html>
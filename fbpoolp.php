  ...
  <TR>
    ...
    <TD vAlign=top width=560>
      ...
      <form name="form1" method="post" action=$page>
        <p>Choose week
          <select name="FbWeek">
            <option value="1">Week 1 - 9.10.15</option>
            <option value="2">Week 2 - 9.17.15</option>
            <option value="3">Week 3 - 9.24.15</option>
            <option value="4">Week 4 - 10.1.15</option>
            <option value="5">Week 5 - 10.8.15</option>
            <option value="6">Week 6 - 10.15.15</option>
            <option value="7">Week 7 - 10.22.15</option>
            <option value="8">Week 8 - 10.29.15</option>
            <option value="9">Week 9 - 11.5.15</option>
            <option value="10">Week 10 - 11.12.15</option>
            <option value="11">Week 11 - 11.19.15</option>
            <option value="12">Week 12 - 11.26.15</option>
            <option value="13">Week 13 - 12.3.15</option>
            <option value="14">Week 14 - 12.10.15</option>
            <option value="15">Week 15 - 12.17.15</option>
            <option value="16">Week 16 - 12.24.15</option>
            <option value="17">Week 17 - 12.31.15</option>
          </select>
        </p>
HERE;
